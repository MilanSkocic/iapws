...
real(dp), parameter ::  Tc = 647.096_dp !! critical temperature of water in K
real(dp), parameter ::  pc = 22.064_dp !! critical pressure of the water in MPa
real(dp), parameter :: rhoc = 322.0_dp !! critical density of the water in kg.m-3.

real(dp), parameter :: R = 0.461526_dp !! Specific gas constant 0.461 526 kJ.kg-1.K-1
    
real(dp), parameter :: r1_ps = 16.53_dp
real(dp), parameter :: r1_ts = 1386.0_dp
