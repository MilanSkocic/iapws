program iapwscli
    ...
    help_text=[character(len=72) :: &
        ...
        'iapws - compute (heavy) water properties.', &
        '', &
        'SUBCOMMANDS:', &
        ...
        '                                                                      ', &
        'OPTIONS                                                          ', &
        '  -T, --temperature TEMPERATURE...  Temperature in °C.', &
        '  -p, --pressure PRESSURE...        Pressure in bar.', &
        '  -f, --fugacity FUGACITY...        Liquid-phase fugacity in MPa.     ', & 
        '  -x, --x2 X2...                    Molar fraction of gas in water.   ', &
        '  -g, --gases GAS...                Gases for which to compute kD.    ', &
        '  --D20                             Set heavywater as the solvent.    ', &
        '  --listgases                       Display available gases.       ', &
